...
class TransformComponent(Entity):
    ...
    def on_init(self, position=(0,0), width = 0, height = 0, size=None, uniform_size=None, speed = 0, rotation=0, direction=(0,0)):
    ...
    def set_attributes(self, speed=0, gravity=0, direction=(0,0)):
        self.speed = speed
